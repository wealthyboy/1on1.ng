            ...
            <div class="container">
                <div class="footer-middle">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-6">
                            <div class="widget">
                                <h4 class="widget-title text-white mb-2">Social</h4>

                                <ul class="links list-unstyled">
                                    <li class="mb-2">
                                        <a href="https://twitter.com/1on1.ng" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <li class="mb-2">
                                        <a href="https://www.instagram.com/1on1.ng" target="_blank" rel="noopener noreferrer">
                                            <svg width="2em" height="2em" viewBox="0 0 24 24" fill="none" aria-hidden="true" class="mc-icon mc-icon--3 mc-opacity--muted mc-mr-4" role="img">
                                    ...
                                    <li class="mb-2">
                                        <a href="https://www.facebook.com/1on1.ng" target="_blank" rel="noopener noreferrer">
                                            <svg width="2em" height="2em" viewBox="0 0 24 24" fill="none" aria-hidden="true" class="mc-icon mc-icon--3 mc-opacity--muted mc-mr-4" role="img">
                                    ...
                                    <li class="mb-2">
                                        <a href="https://youtube.com/c/1on1.ng" target="_blank" rel="noopener noreferrer">
                                            <svg width="2em" height="2em" viewBox="0 0 24 24" fill="none" aria-hidden="true" class="mc-icon mc-icon--3 mc-opacity--muted mc-mr-4" role="img">
                                    ...
                                    <li class="mb-2">
                                        <a href="https://www.linkedin.com/company/1on1.ng" target="_blank" rel="noopener noreferrer">
                                            <svg width="2em" height="2em" viewBox="0 0 24 24" fill="none" aria-hidden="true" class="mc-icon mc-icon--3 mc-opacity--muted mc-mr-4" role="img">
                ...
                <div class="footer-bottom  d-flex border-top justify-content-center align-items-center ">
