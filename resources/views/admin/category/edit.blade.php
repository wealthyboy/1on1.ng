               ...
               <div class="row mt-3">
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <textarea type="text" class="form-control" name="meta_description" rows="8" onfocus="focused(this)" onfocusout="defocused(this)">{{ $cat->description }}</textarea>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-sm-12 col-12">
                     <div class="input-group input-group-outline">
                        ...
                        <select class="form-control" name="type" id="">
                           ...
                           <option class="" {{  $cat->type == 'auction' ? 'selected' : '' }} value="auction">Auction</option>
                           <option class="" {{  $cat->type == 'shout_out' ? 'selected' :  '' }} value="shout_out">Shout Out</option>
                           <option class="" {{  $cat->type == 'master_class' ? 'selected' :  '' }} value="master_class">Master Class</option>
                        </select>
                     </div>
                  </div>
               </div>
